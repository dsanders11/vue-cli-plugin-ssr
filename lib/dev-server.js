...
module.exports.setupDevServer = ({ server, templatePath, onUpdate }) => new Promise((resolve, reject) => {
  ...
  const projectOptions = config.service.projectOptions
  let watchOptions = {}

  if (projectOptions.devServer && projectOptions.devServer.watchOptions) {
    watchOptions = projectOptions.devServer.watchOptions
  }
